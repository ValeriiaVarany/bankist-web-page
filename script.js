...
message.innerHTML = 'We use cookies for improved functionalityand analytics. <button class="btn  btn--close-cookie"> Got it!</button>';
...
//onsole.log(h1.nextElementSibling);
...
slider.style.transform = 'scale(1) translateX(1px)';
